      ...
      <section className="py-24 lg:py-32 px-8 bg-mustard/[0.06]">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="scroll-reveal relative flex items-center justify-center">
            ...
            <div className="hidden lg:block absolute -right-4 top-16 bg-dusty-rose/15 text-dusty-rose rounded-full px-4 py-2 text-xs font-semibold shadow-sm rotate-2">14,000+ items in our database 
